import { MessageSquare, LayoutDashboard, Database, Settings, Link, GitBranch } from 'lucide-react'
import SimpleThemeToggle from './SimpleThemeToggle'

interface SidebarProps {
  currentView: 'workflow' | 'chat' | 'dashboards' | 'connections'
  onViewChange: (view: 'workflow' | 'chat' | 'dashboards' | 'connections') => void
}
